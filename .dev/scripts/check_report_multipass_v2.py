...
OLLAMA_NUM_CTX = 4096       # Minimal context — each pass is focused, doesn't need more
OLLAMA_NUM_PREDICT = 2048   # JSON passes need ~1K tokens max, summary needs more

# Per-pass context overrides (Pass 6 summary needs more room)
PASS_CTX = {
    "pass1": 4096,
    "pass2": 4096,
    "pass3": 4096,
    "pass4": 2048,   # Staging is near-algorithmic, tiny context needed
    "pass5": 4096,
    "pass6": 4096,   # Summary generation
}
PASS_PREDICT = {
    "pass1": 2048,
    "pass2": 2048,
    ...
    "pass4": 1024,
    "pass5": 1536,
    "pass6": 2048,   # Human-readable report needs more tokens
}
...
class MultiPassAnalyzer:
    ...
    def _call(self, prompt: str, system: str = "", pass_name: str = "") -> str:
        ctx = PASS_CTX.get(pass_name, OLLAMA_NUM_CTX)
        pred = PASS_PREDICT.get(pass_name, OLLAMA_NUM_PREDICT)
        return call_llm(prompt, self.provider, self.model, self.base_url,
                        system, num_ctx=ctx, num_predict=pred)
    ...
    def _call_json(self, prompt: str, system: str = "", pass_name: str = "") -> dict:
        ...
        if "_parse_error" in result:
            ...
            raw = self._call(retry_prompt, system, pass_name)
            result = extract_json(raw)
    ...
    def pass1_extract(self, report_text: str) -> dict:
        ...
        return self._call_json(prompt, PASS1_SYSTEM, "pass1")
    ...
    def pass2_compliance(self, extracted: dict) -> dict:
        ...
        return self._call_json(prompt, PASS2_SYSTEM, "pass2")
    ...
    def pass3_macroscopy(self, macroscopy_text: str) -> dict:
        ...
        return self._call_json(prompt, PASS3_SYSTEM, "pass3")
    ...
    def pass4_staging(self, extracted: dict) -> dict:
        ...
        return self._call_json(prompt, PASS4_SYSTEM, "pass4")
    ...
    def pass5_crossvalidate(self, p1: dict, p2: dict, p3: dict, p4: dict) -> dict:
        ...
        return self._call_json(prompt, PASS5_SYSTEM, "pass5")
    ...
    def pass6_summary(self, case_no: str, p1: dict, p2: dict,
        ...
        return self._call(prompt, PASS6_SYSTEM, "pass6")
