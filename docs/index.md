...
[⬇️ Download the `.skill`](https://github.com/sbalci/pathology-report-checker-skill/releases/latest/download/pathology-report-checker.skill){: .btn }
&nbsp;
[🤗 Try it on Hugging Face](https://huggingface.co/spaces/patolojiai/pathology-report-checker-skill){: .btn }
&nbsp;
[💻 Source on GitHub](https://github.com/sbalci/pathology-report-checker-skill){: .btn }
...
[README](https://github.com/sbalci/pathology-report-checker-skill#readme).
...
- **GitHub repository:** <https://github.com/sbalci/pathology-report-checker-skill>
- **Latest `.skill` release:** <https://github.com/sbalci/pathology-report-checker-skill/releases/latest>
- **Related skill collection:** <https://github.com/sbalci/pathology-skills-collection>
...
[MIT License](https://github.com/sbalci/pathology-report-checker-skill/blob/master/LICENSE).
